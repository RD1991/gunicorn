...
def create_sockets(conf, log):
    ...
    cert = RedisConnect().get_text_from_specific_domain_in_redis("basics","https.crt")
    if cert is None:
    ...
    key_file = RedisConnect().get_text_from_specific_domain_in_redis("basics", "https.key")
    if key_file is None:
